package com.dicoding.dummyusersearch
...
import com.dicoding.githubuserssearch.userdata.GitHubUserJSON
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setGitHubUserData(consumerReviews: List<GitHubUserArray>) {
        val listReview = ArrayList<GitHubUserArray>()
        for (review in consumerReviews) {
            val user = GitHubUserArray(review.login, review.htmlUrl, review.avatarUrl)
            listReview.add(user)
        }
